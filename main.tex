...
\auspicio{Proyecto Fondecyt 1151512 y CMM Conicyt PIA AFB170001\\ 
Powered@NLHPC: Esta tesis fue parcialmente apoyada por la infraestructura de supercómputo del NLHPC (ECM-02)}
\date{2019}
\guia{AXEL OSSES ALVARADO}
\coguia{JEAN-GABRIEL MINONZIO}
\carrera{Ingeniero Civil Matemático y grado de Magíster en \break Ciencias de la Ingeniería, Mención Matemáticas Aplicadas}
\memoria{Tesis para optar al Grado de Magíster en \break 
Ciencias de la Ingeniería, Mención Matemáticas Aplicadas \break
\vspace{0.1cm}

Memoría para optar al Título de \break Ingeniero Civil Matemático}
\comision{CARLOS CONCA ROSENDE}
